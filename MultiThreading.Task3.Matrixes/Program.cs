...
namespace MultiThreading.Task3.MatrixMultiplier
{
    class Program
    {
        ...
        private static void CreateAndProcessMatrices(byte sizeOfMatrix)
        {
            ...
            IMatrix resultMatrix1 = new MatricesMultiplierParallel().Multiply(firstMatrix, secondMatrix);
            stopwatch1.Stop();
            Console.WriteLine("Multiply seconds (parallel): " + stopwatch1.ElapsedMilliseconds);
            resultMatrix1.Print();
        }
    }
}
